...
CUDA_VISIBLE_DEVICES=$GPUS fairseq-hydra-train task.data=$DATA_PATH/data/LS/train-960-d2v2_100h_state@2 \
    ...
    model.w2v_path=$CKPTPATH model.mask_prob=0.55 +model.apply_prior_mask=false +model.freeze_prior_applies=40000 \
